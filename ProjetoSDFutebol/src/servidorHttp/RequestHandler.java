...
public class RequestHandler implements HttpHandler{
	...
	public void handle(HttpExchange exg) throws IOException {
		...
		if(requestURI.matches("\\/getAvailabeYears$")) {
			...
			response = q.getPlayerNameQueryResult(ano + "", playerName).getBytes();
			...
			response = q.getClubNameQueryResult(ano + "", clubName).getBytes();
			...
			response = q.getClubNameAndPlayerNameQueryResult(ano + "", clubName, playerName).getBytes();
